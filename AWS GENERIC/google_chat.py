...
class ChatSender:
    ...
    RESOLVED_IMG = 'https://grupohiato.com/wp-content/uploads/2022/01/checkbox-icon-3.png'
    ...
    def sendMessage(self, event):
        ...
        # Se for uma mensagem de problema
        if status == "0":
            time = event[1]
            date = event[2]
        ...
        # Se for uma mensagem de resolução
